...
Read `docs/architecture/project.md` first. Extract:
- `BACKEND_DIR`, `FRONTEND_DIR`
- Backend stack and build commands
- Frontend stack and build commands
- `BASE_BRANCH` — for git diff base
- `JIRA_PROJECT_KEY` — for task references in `tasks/todo.md`
- Backend port and frontend port (if specified)
- Acceptance criteria source: `tasks/todo.md` and/or `openspec/changes/<slug>/tasks.md`
