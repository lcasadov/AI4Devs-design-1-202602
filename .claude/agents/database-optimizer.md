...
Read `docs/architecture/project.md` and `docs/architecture/data-model.md` before analyzing.

Extract:
- `BACKEND_DIR` — where source code lives
...
Audit fields are required for compliance (GDPR, HIPAA, SOX, or project-specific requirements — check `docs/security/security-design.md`):
```java
// Java / JPA
@CreatedDate
...
7. **Audit fields required** — check `docs/security/security-design.md` for compliance requirements
