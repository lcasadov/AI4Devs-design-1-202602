...
Prompts utilizados para generar la documentación del proyecto RecruitFlow con Claude.
...
| 03 | [Modelo de datos](./03-modelo-de-datos.md) | `docs/architecture/data-model.md`, `docs/architecture/data-model-additional.md` |
| 04 | [Arquitectura del sistema](./04-arquitectura.md) | `docs/architecture/project.md` |
| 05 | [Contratos API y OpenAPI](./05-contratos-api-openapi.md) | `docs/architecture/openapi.yaml` |
